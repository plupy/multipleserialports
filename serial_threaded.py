...
"""
---------------------------------------------------------------------
   File Name:    serial_threaded.py  
   Description:  Support threading with serial ports.
                 Refering to pySerail implementation.
   Author:       Zhang Wei
   Date:         2017/04/06
---------------------------------------------------------------------
   Change Activity:
...
class ReaderThread(threading.Thread):
    ...
    def __init__(self, serial_instance, protocol_factory, protocol_args=None):
        """\
        Initialize thread.
    ...
    def run(self):
        ...
        if self.protocol_args:
            self.protocol = self.protocol_factory(self.protocol_args)
        else:
